...
#include "velodyne_vls_pointcloud/colors.h"
#include <velodyne_vls_pointcloud/point_types.h>
...
RingColors::RingColors(ros::NodeHandle node, ros::NodeHandle private_nh)
{
  ...
  output_ = node.advertise<sensor_msgs::PointCloud2>("velodyne_rings", 10);

  // subscribe to VelodyneScan packets
  input_ = node.subscribe(
    "velodyne_points", 10, &RingColors::convertPoints, this,
